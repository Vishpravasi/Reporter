...
function LoadViewDetails() {
    ...
    $.ajax({
        url: gStrIpVal + "/NewsStreamService.svc/VersionViewDetails",
        cache: false,
        type: "POST",
        async: false,
        ...
        success: function (data) {
            ...
            if (data.VersionViewDetailsResult.length > 0) {
                $.each(data.VersionViewDetailsResult, function (index, value) {
                    if ((data.VersionViewDetailsResult[index].strstatus == "T" && data.VersionViewDetailsResult[index].strArticles_Created == window.sessionStorage.strUserId) || data.VersionViewDetailsResult[index].strstatus != "T") {
                        var strStyleBkColor = "";
                        if (data.VersionViewDetailsResult[index].strChiefRepoterViewed == "Y")
                            strStyleBkColor = "style='background-color: #FFFACD;'";
                        if (data.VersionViewDetailsResult[index].strEditorViewed == "Y")
                            strStyleBkColor = "style='background-color: #AFEEEE;'";
                        if (data.VersionViewDetailsResult[index].strSubEditorViewed == "Y")
                            strStyleBkColor = "style='background-color: #D8BFD8;'";

                        strVal += "  <tr title='" + data.VersionViewDetailsResult[index].strcontent + "' " + strStyleBkColor + "> ";
                        strVal += " <td class='strParentId'>" + data.VersionViewDetailsResult[index].ParentId + "</td> ";
                        strVal += " <td class='StoryRef'>" + data.VersionViewDetailsResult[index].strRef_story_name + "</td> ";
                        strVal += " <td >" + data.VersionViewDetailsResult[index].strArtCreated_Date + "</td> ";
                        strVal += " <td style='display:none' class='Caption'>" + data.VersionViewDetailsResult[index].Caption + "</td> ";
                        strVal += " <td class='Zone'>" + data.VersionViewDetailsResult[index].Zone + "</td> ";
                        strVal += " <td class='IssueDate'>" + data.VersionViewDetailsResult[index].IssueDate + "</td> ";
                        strVal += " <td class='Page'>" + data.VersionViewDetailsResult[index].strPageName + "</td> ";
                        if (data.VersionViewDetailsResult[index].strstatus != "A") {
                        ...
                        strVal += " <td class=''>" + data.VersionViewDetailsResult[index].strCreatedUser + "</td> ";
                        if (window.sessionStorage.strUserGroup == "RPT") {
                            strVal += " <td class=''>" + data.VersionViewDetailsResult[index].strReportUser + "</td> ";
                            strVal += " <td class=''>" + data.VersionViewDetailsResult[index].strChiefReportUser + "</td> ";
                            strVal += " <td class=''>" + data.VersionViewDetailsResult[index].strEditorialUser + "</td> ";
                            strVal += " <td class=''>" + data.VersionViewDetailsResult[index].strSubEditorialUser + "</td> ";
                        }
                        ...
                        if (window.sessionStorage.strUserGroup == "EDTSUP") {
                            strVal += " <td class=''>" + data.VersionViewDetailsResult[index].strSupplementary_Editor + "</td> ";
                            //strVal += " <td class=''>" + data.VersionViewDetailsResult[index].strSubEditorialUser + "</td> ";
                        }
                        strVal += " <td class='version'>" + data.VersionViewDetailsResult[index].strArtCreated_Date + "</td> ";
                        //                    }
                        //                    else {
                        //                        strVal += " <td style='display:none;' class=''></td>";
                        //                    }
                        strVal += " <td>";
                        if (data.VersionViewDetailsResult[index].strstatus != "A" && window.sessionStorage.strUserGroup != "SUP" && (data.VersionViewDetailsResult[index].strProcessedUser == "" || data.VersionViewDetailsResult[index].strProcessedUser == window.sessionStorage.strUserId)) {
                            strVal += " <a class='btn btn btn-primary' href='ArticleEditor.html?ArticleId=" + data.VersionViewDetailsResult[index].ParentId + "&Display=EDIT'>Edit </a>";
                        }
                        //                    if ((window.sessionStorage.strUserGroup == "SUP" || window.sessionStorage.strUserGroup == "EDT" || window.sessionStorage.strUserGroup == "CHRPT" || window.sessionStorage.strUserGroup == "SUBEDT") && data.VersionViewDetailsResult[index].strstatus != "A") {
                        var strProcessAnotherUser = "";
                        if ((data.VersionViewDetailsResult[index].strProcessedUser != "" && data.VersionViewDetailsResult[index].strProcessedUser != window.sessionStorage.strUserId)) {
                            strProcessAnotherUser = " title='The story cannot modify because it is being used by " + data.VersionViewDetailsResult[index].strProcessedUser + " user ' ";
                        }
                        strVal += " <a class='btn btn btn-primary' " + strProcessAnotherUser + "  href='ArticleEditor.html?ArticleId=" + data.VersionViewDetailsResult[index].ParentId + "&Display=View'>View </a>";
                        if (window.sessionStorage.strUserGroup != "SUP")
                            strVal += " <a class='btn btn btn-primary' id='" + data.VersionViewDetailsResult[index].ParentId + "' title='" + data.VersionViewDetailsResult[index].strRef_story_name + "' onclick='DeleteStory(this.id, this.title)' >Delete </a>";
                        //                    }
                        strVal += "  </td>";
                        strVal += " </tr> ";
                    }
...
function GetGroupName() {
    if (window.sessionStorage.strUserGroup == "RPT") {
        $('.clsStyGpname').text('Story Versions - Reporter');
    }
    if (window.sessionStorage.strUserGroup == "CHRPT") {
        $('.clsStyGpname').text('Story Versions - Chief Reporter');

    }
    if (window.sessionStorage.strUserGroup == "EDT") {
        $('.clsStyGpname').text('Story Versions - Editor');

    }
    if (window.sessionStorage.strUserGroup == "SUBEDT") {
        $('.clsStyGpname').text('Story Versions - Sub Editor');
    }
    if (window.sessionStorage.strUserGroup == "EDTSUP") {
        $('.clsStyGpname').text('Story Versions - Supplementary Editor');
    }
}
